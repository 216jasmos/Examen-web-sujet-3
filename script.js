...
const titre = document.querySelector('#bouton1')
if (titre) {
...
const titre2 = document.querySelector('#bouton2')
if (titre2) {
...
const titre3 = document.querySelector('#bouton3')
if (titre3) {
